      ...
      {filteredList.map(o => (
        ...
        <div key={o.id} className="bg-white dark:bg-zinc-900 rounded-2xl border border-zinc-100 dark:border-zinc-800 p-6 shadow-sm hover:border-primary-500/30 transition-all">
          ...
          <div className="flex gap-2 mt-6">
            ...
            {o.status === 'confirmed' && (
              <>
                <Button size="sm" variant="outline" onClick={() => window.open(`https://wa.me/55${o.customerWhatsapp.replace(/\D/g, '')}`, '_blank')} className="rounded-xl px-4 h-10 border-green-500 text-green-500 hover:bg-green-50 dark:hover:bg-green-900/20">
                ...
                <Button size="sm" onClick={() => updateOrderStatus(o.id, 'delivered')} className="rounded-xl px-6 h-10 ml-auto bg-emerald-600 hover:bg-emerald-700 shadow-lg shadow-emerald-500/20 uppercase font-black text-[10px] tracking-widest">Venda Finalizada</Button>
              </>
            )}
